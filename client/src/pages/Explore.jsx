  ...
  return (
    <div className="font-sans">
      ...
      <div className=" bg-gradient-to-b from-black via-blue-950 to-slate-950 py-10 ">
        <motion.section
          className="px-6 md:pt-10 md:px-10 pb-10 -mt-[75vh] w-[90vw] md:w-[90vw] xl:w-[80vw] flex flex-col justify-around space-y-0 mx-auto border-2 border-slate-900 rounded-3xl shadow-2xl bg-slate-500 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20"
          style={{
            maxWidth: "1200px",
          }}
          initial="hidden"
        ...
        {sections.map((section, i) => (
          ...
          >
            <div className="flex justify-between items-center mb-6 gap-4">
              ...
              <Link to='/course' className='border border-white text-white px-4 py-2 rounded-full font-semibold hover:scale-105 hover:bg-gray-200 hover:text-black hover:shadow-lg transition duration-300 flex-shrink-0 whitespace-nowrap'>View All</Link>
            </div>
            {section.flex ? (
